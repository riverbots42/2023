<%
// Main page that you hit when you visit https://love.riverbots.org, with a code in the URL (2024 version).
//
// A request of the form "https://love.riverbots.org/2024" without a code will redirect to landing.html.
